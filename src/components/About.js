    ...
    return(
      <>
        ...
        <div className="main-content">
          ...
          <p>
          Dobrodošli u MEDIPAN, mladu i dinamičnu radionicu koja se bavi proizvodnjom vrhunskog pločastog namještaja po mjeri od iverice i medijapana. Iako smo tek započeli svoje poslovanje, brzo se razvijamo i težimo postati vodeći proizvođač modernog namještaja.
